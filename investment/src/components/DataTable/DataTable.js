    ...
    <table className={styles.result}>
      ...
      <tbody>
        {props.data.map((item) => {
          ...
          const savingsEndOfYear = formatter.format(item.savingsEndOfYear);
          const yearlyInterest = formatter.format(item.yearlyInterest);
          const totalInterest = formatter.format(item.totalInterest);
          const investedCapital = formatter.format(item.investedCapital);
